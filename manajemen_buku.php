...
<nav>
    <ul>
        ...
        <li><a href="manajemen_buku.php" class="active">Manajemen Buku</a></li>
        <li><a href="anggota.php">Peminjaman</a></li>
        <li><a href="peminjaman.php">Tentang Kami</a></li>
    ...
    <div class="pos">
        <div class="card">
            ...
            <div class="card-details">
                <h3 class="book-title">Menu Navigasi Responsive</h3>
                <p class="book-details">Penulis</p>
                <p class="book-details">Penerbit</p>
